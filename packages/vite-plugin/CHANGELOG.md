...
- 85ab742: feat: add HMR support for CSS declared in manifest content_scripts
- 85ab742: add: browser_specific_settings.gecko properties
- 85ab742: Fix "TypeError: plugins is not iterable" error when using
...
- 85ab742: fix: resolve TypeScript types correctly for ESM and CJS consumers
- 85ab742: feat: add Vite 8 beta support

### Patch Changes

- 85ab742: ci: migrate release workflow to npm trusted publishers
- 85ab742: fix: copy CSS files declared in manifest content_scripts to output
- 85ab742: Replace cheerio with node-html-parser to fix npm deprecation warning
  for whatwg-encoding.
...
- 85ab742: ci: run compat tests against stable Vite 8, make the vite8 available
  as a peer dependency
- 85ab742: fix: UnoCSS/TailwindCSS HMR issues with virtual CSS modules
- 85ab742: fix: respect user's build.manifest setting in Vite 4+
...
- 85ab742: feat(client): Update the style and content of the development mode
  loading page
