...
- edc584f: feat: add HMR support for CSS declared in manifest content_scripts
- edc584f: add: browser_specific_settings.gecko properties
- edc584f: Fix "TypeError: plugins is not iterable" error when using
...
- edc584f: fix: resolve TypeScript types correctly for ESM and CJS consumers
- edc584f: feat: add Vite 8 beta support

### Patch Changes

- edc584f: ci: migrate release workflow to npm trusted publishers
- edc584f: fix: copy CSS files declared in manifest content_scripts to output
- edc584f: Replace cheerio with node-html-parser to fix npm deprecation warning
  for whatwg-encoding.
...
- edc584f: ci: run compat tests against stable Vite 8, make the vite8 available
  as a peer dependency
- edc584f: fix: UnoCSS/TailwindCSS HMR issues with virtual CSS modules
- edc584f: fix: respect user's build.manifest setting in Vite 4+
...
- edc584f: feat(client): Update the style and content of the development mode
  loading page
